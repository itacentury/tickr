...
class TestIconIndex:
    ...
    def test_icon_index_prefers_dist_over_legacy(self, tmp_path, monkeypatch):
    ...
    def test_icon_index_missing_dirs_yields_empty(self, tmp_path, monkeypatch):
    ...
    def test_serve_icon_404_for_missing(self, client, tmp_path, monkeypatch):
    ...
    def test_serve_icon_returns_indexed_file(self, client, tmp_path, monkeypatch):
